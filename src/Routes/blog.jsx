...
export default class Blog extends Component{
	...
	render(){
		...
		if (blogPosts){
			return(
		<div>
		<div id="home" className="justify-content-center" style={{fontFamily: "Trebuchet MS", paddingTop: "7vh", textAlign: "center",paddingBottom: "3vh"}}><h1 className="display-4 text-center justify-content-center"><strong>Ready Progammer One</strong></h1>
		<h3><small class="text-muted">A blog, by <span className="text-primary"><Link to="/">Kinshuk Phalke</Link></span>, where I post whatever's on my mind.</small></h3></div>
