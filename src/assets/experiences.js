let experiences = [
    {
        title: "High Performance Architecture Lab",
        job: "Undergraduate Research Assistant",
        duration: "Jan 2023 - Present",
        description: `I am working at the <span class="highlight">High
    ...
    },
    {
        ...
        description: `For 12 weeks, I worked at the NCR Corporation
        Headquarters in Altanta, GA. I worked on the <span class="highlight">Retail
        Innovation - Edge Team</span>. <br> <br> With a team of 5 other interns, I
        worked on the <span class="highlight"> GoKart Selling Service</span>, which is
        ...
        </span> at comparable performance. <br> <br> Along with the api, we worked on a
        sample e-commerce website written in <span class="highlight">Next.js </span>on
        incorporating API into the frontend. To help with development, I also made a
        <span class="highlight">bash script </span> with 12 different presets to help
        in development, building, running and deployment to Google Cloud Platform.` 
    },
    {
        title: "Notitia",
        job: "Software Developer",
