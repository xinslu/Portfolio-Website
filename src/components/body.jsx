  ...
  const Body = () => {
  	return(
            ...
            <div id="about_me">   
              ...
              <p className="lead">Hey, I am Kinshuk Phalke, a rising sophmore at the <span className="text-primary">Georgia Institute of technology, Atlanta</span>, where I major in <span className="text-primary">Computer Science</span> and specialize in <span className="text-primary">Systems and Architecture</span> and <span className="text-primary">Intelligence</span>. I am interested in <span className="text-primary">FinTech, Web3, Machine Learning Research, Programming Languages</span> and <span className="text-primary">Processor Design</span>. When, I am not coding you can find me watching a Sci-Fi Series or trying to make a funny meme. Welcome to my personal Website, where I list my personal projects and achievements!</p>
          	</div>
            ...
            <h4 className="text-primary pt-2">NCR Corporation</h4><p className="lead">Incoming Summer Intern at NCR Corporation, Atlanta.</p>
            ...
            <h4 className="text-primary pt-2">Notitia</h4><p className="lead">I am working in a start up at Gerogia Tech in building a MVP. I worked on developing a <span className="text-primary">Full-Stack Website</span> and working on fine tuning an NLP model for more accurate results. I worked on a machine learning pipeline that uses <span className="text-primary">UMAP</span> to map the relevant word embeddings of pieces of text onto a 2D graph, <span className="text-primary">FAISS</span> to effieciently cluster these texts and an <span className="text-primary">LDA model</span> on these clusters to find accurate topics for these. In the frontend, I worked on optimizing WordCloud of test using <span className="text-primary">ReactFlow</span>.</p>
            ...
            <h4 className="text-primary pt-2">Libraries</h4>
            <ul style={{listStyleType: "none"}}>
            <li><h5 className="text-primary" style={{display: "inline"}}><i class="devicon-numpy-plain"></i></h5> Numpy</li>
            <li><h5 className="text-primary" style={{display: "inline"}}><i class="devicon-pandas-plain"></i></h5> Pandas</li>
            <li><h5 className="text-primary" style={{display: "inline"}}><i class="devicon-tensorflow-original"></i></h5> Tensorflow</li>
            </ul>
