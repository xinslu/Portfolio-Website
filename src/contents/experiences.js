let experiences = [
    {
        ...
        description: `For 12 weeks, I worked at the NCR Corporation Headquarters in Altanta, GA. I worked on the <span class="highlight">Retail Innovation - Edge Team</span>. <br> <br> With a team of 5 other interns, I worked on the <span class="highlight"> GoKart Selling Service</span>, which is a API written in the <span class="highlight">Fiber Web Server</span> in Golang. This service allows for the support of <span class="highlight">creation, storage, and management of a cart object </span> achieved with a unique cart identifier. The cart supports the inclusion of items retrieved through requests to the <span class="highlight"> NCR BSP Catalog API</span>, and store locations through to the <span class="highlight">BSP Site API</span>. The cart also supports a selling engine and its pertinent calculations like calculating gross-totals, totals with promotions applied, exemptions applied, and taxes applied, as well as the calculation and handling of returns. The app is meant to work with exsisting <span class="highlight"> retail e-commerce apps </span> and <span class="highlight">Point of Sale systems</span>. This was made to the replace the existing .NET API as this was rather bulky and slow, we managed to cut down the size of the binary from 100MB to just <span class="highlight"> 5MB </span> at comparable performance. <br> <br> Along with the api, we worked on a sample e-commerce website written in <span class="highlight">Next.js </span>on incorporating API into the frontend. To help with development, I also made a <span class="highlight">bash script </span> with 12 different presets to help in development, building, running and deployment to Google Cloud Platform.`
    },
    {
        title: "Notitia",
        job: "Software Developer",
